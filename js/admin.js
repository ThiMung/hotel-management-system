...
async function loadTable(endpoint, tableId, fields, editHandler = null, deleteHandler = null) {
    try {
...
// Quản lý Rooms
function loadRooms() {
    loadTable('rooms', 'roomsTable', ['id', 'name', 'type', 'price', 'status', 'image'], 
        (room) => {
...
document.getElementById('cancelRoomModalBtn')?.addEventListener('click', () => closeModal('roomModal'));
document.getElementById('closeRoomModal')?.addEventListener('click', () => closeModal('roomModal'));

// Quản lý Services
function loadServices() {
    loadTable('services', 'servicesTable', ['id', 'name', 'description', 'price', 'image'], 
        (service) => {
...
document.getElementById('cancelServiceModalBtn')?.addEventListener('click', () => closeModal('serviceModal'));
...
function loadBookings() {
    loadTable('bookings', 'bookingsTable', ['id', 'customerId', 'roomId', 'checkIn', 'checkOut', 'status', 'selectedServices']);
}
